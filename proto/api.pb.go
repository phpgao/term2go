...
type GetPromptResponse struct {
	...
	// fire.
	ExcludedSubranges []*CoordRange `protobuf:"bytes,11,rep,name=excluded_subranges,json=excludedSubranges" json:"excluded_subranges,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *GetPromptResponse) GetExcludedSubranges() []*CoordRange {
	if x != nil {
		return x.ExcludedSubranges
	}
	return nil
}
...
const file_api_proto_rawDesc = "" +
	...
	"\asession\x18\x01 \x01(\tR\asession\x12(\n" +
	"\x10unique_prompt_id\x18\x02 \x01(\tR\x0euniquePromptId\"\x9a\x05\n" +
	...
	" \x01(\tR\x0euniquePromptId\x12A\n" +
	"\x12excluded_subranges\x18\v \x03(\v2\x12.iterm2.CoordRangeR\x11excludedSubranges\"V\n" +
	"\x06Status\x12\x06\n" +
	"\x02OK\x10\x00\x12\x15\n" +
	"\x11SESSION_NOT_FOUND\x10\x01\x12\x15\n" +
	"\x11REQUEST_MALFORMED\x10\x02\x12\x16\n" +
	...
	"\x05KITTY\x10\x02B!Z\x1fgithub.com/phpgao/term2go/proto"
...
var file_api_proto_depIdxs = []int32{
	...
	141, // 186: iterm2.GetPromptResponse.excluded_subranges:type_name -> iterm2.CoordRange
	38,  // 187: iterm2.ListPromptsResponse.status:type_name -> iterm2.ListPromptsResponse.Status
	39,  // 188: iterm2.GetProfilePropertyResponse.status:type_name -> iterm2.GetProfilePropertyResponse.Status
	133, // 189: iterm2.GetProfilePropertyResponse.properties:type_name -> iterm2.ProfileProperty
	214, // 190: iterm2.SetProfilePropertyRequest.guid_list:type_name -> iterm2.SetProfilePropertyRequest.GuidList
	215, // 191: iterm2.SetProfilePropertyRequest.assignments:type_name -> iterm2.SetProfilePropertyRequest.Assignment
	40,  // 192: iterm2.SetProfilePropertyResponse.status:type_name -> iterm2.SetProfilePropertyResponse.Status
	41,  // 193: iterm2.TransactionResponse.status:type_name -> iterm2.TransactionResponse.Status
	57,  // 194: iterm2.LineRange.windowed_coord_range:type_name -> iterm2.WindowedCoordRange
	142, // 195: iterm2.CoordRange.start:type_name -> iterm2.Coord
	142, // 196: iterm2.CoordRange.end:type_name -> iterm2.Coord
	5,   // 197: iterm2.CellStyle.fgAlternate:type_name -> iterm2.AlternateColor
	143, // 198: iterm2.CellStyle.fgRgb:type_name -> iterm2.RGBColor
	5,   // 199: iterm2.CellStyle.bgAlternate:type_name -> iterm2.AlternateColor
	143, // 200: iterm2.CellStyle.bgRgb:type_name -> iterm2.RGBColor
	6,   // 201: iterm2.CellStyle.image:type_name -> iterm2.ImagePlaceholderType
	143, // 202: iterm2.CellStyle.underlineColor:type_name -> iterm2.RGBColor
	144, // 203: iterm2.CellStyle.url:type_name -> iterm2.URL
	147, // 204: iterm2.LineContents.code_points_per_cell:type_name -> iterm2.CodePointsPerCell
	42,  // 205: iterm2.LineContents.continuation:type_name -> iterm2.LineContents.Continuation
	145, // 206: iterm2.LineContents.style:type_name -> iterm2.CellStyle
	43,  // 207: iterm2.SendTextResponse.status:type_name -> iterm2.SendTextResponse.Status
	152, // 208: iterm2.Frame.origin:type_name -> iterm2.Point
	151, // 209: iterm2.Frame.size:type_name -> iterm2.Size
	153, // 210: iterm2.SessionSummary.frame:type_name -> iterm2.Frame
	151, // 211: iterm2.SessionSummary.grid_size:type_name -> iterm2.Size
	216, // 212: iterm2.SplitTreeNode.links:type_name -> iterm2.SplitTreeNode.SplitTreeLink
	217, // 213: iterm2.ListSessionsResponse.windows:type_name -> iterm2.ListSessionsResponse.Window
	154, // 214: iterm2.ListSessionsResponse.buried_sessions:type_name -> iterm2.SessionSummary
	133, // 215: iterm2.CreateTabRequest.custom_profile_properties:type_name -> iterm2.ProfileProperty
	44,  // 216: iterm2.CreateTabResponse.status:type_name -> iterm2.CreateTabResponse.Status
	45,  // 217: iterm2.SplitPaneRequest.split_direction:type_name -> iterm2.SplitPaneRequest.SplitDirection
	133, // 218: iterm2.SplitPaneRequest.custom_profile_properties:type_name -> iterm2.ProfileProperty
	46,  // 219: iterm2.SplitPaneResponse.status:type_name -> iterm2.SplitPaneResponse.Status
	7,   // 220: iterm2.InvokeFunctionResponse.Error.status:type_name -> iterm2.InvokeFunctionResponse.Status
	151, // 221: iterm2.StatusBarComponentRequest.OpenPopover.size:type_name -> iterm2.Size
	59,  // 222: iterm2.SelectionRequest.SetSelectionRequest.selection:type_name -> iterm2.Selection
	59,  // 223: iterm2.SelectionResponse.GetSelectionResponse.selection:type_name -> iterm2.Selection
	180, // 224: iterm2.ColorPresetResponse.GetPreset.color_settings:type_name -> iterm2.ColorPresetResponse.GetPreset.ColorSetting
	182, // 225: iterm2.PreferencesRequest.Request.set_preference_request:type_name -> iterm2.PreferencesRequest.Request.SetPreference
	183, // 226: iterm2.PreferencesRequest.Request.get_preference_request:type_name -> iterm2.PreferencesRequest.Request.GetPreference
	184, // 227: iterm2.PreferencesRequest.Request.set_default_profile_request:type_name -> iterm2.PreferencesRequest.Request.SetDefaultProfile
	185, // 228: iterm2.PreferencesRequest.Request.get_default_profile_request:type_name -> iterm2.PreferencesRequest.Request.GetDefaultProfile
	190, // 229: iterm2.PreferencesResponse.Result.unrecognized_request:type_name -> iterm2.PreferencesResponse.Result.UnrecognizedResult
	187, // 230: iterm2.PreferencesResponse.Result.set_preference_result:type_name -> iterm2.PreferencesResponse.Result.SetPreferenceResult
	188, // 231: iterm2.PreferencesResponse.Result.get_preference_result:type_name -> iterm2.PreferencesResponse.Result.GetPreferenceResult
	189, // 232: iterm2.PreferencesResponse.Result.set_default_profile_result:type_name -> iterm2.PreferencesResponse.Result.SetDefaultProfileResult
	191, // 233: iterm2.PreferencesResponse.Result.get_default_profile_result:type_name -> iterm2.PreferencesResponse.Result.GetDefaultProfileResult
	13,  // 234: iterm2.PreferencesResponse.Result.SetPreferenceResult.status:type_name -> iterm2.PreferencesResponse.Result.SetPreferenceResult.Status
	14,  // 235: iterm2.PreferencesResponse.Result.SetDefaultProfileResult.status:type_name -> iterm2.PreferencesResponse.Result.SetDefaultProfileResult.Status
	201, // 236: iterm2.TmuxResponse.ListConnections.connections:type_name -> iterm2.TmuxResponse.ListConnections.Connection
	133, // 237: iterm2.ListProfilesResponse.Profile.properties:type_name -> iterm2.ProfileProperty
	210, // 238: iterm2.RPCRegistrationRequest.StatusBarComponentAttributes.knobs:type_name -> iterm2.RPCRegistrationRequest.StatusBarComponentAttributes.Knob
	211, // 239: iterm2.RPCRegistrationRequest.StatusBarComponentAttributes.icons:type_name -> iterm2.RPCRegistrationRequest.StatusBarComponentAttributes.Icon
	29,  // 240: iterm2.RPCRegistrationRequest.StatusBarComponentAttributes.format:type_name -> iterm2.RPCRegistrationRequest.StatusBarComponentAttributes.Format
	30,  // 241: iterm2.RPCRegistrationRequest.StatusBarComponentAttributes.Knob.type:type_name -> iterm2.RPCRegistrationRequest.StatusBarComponentAttributes.Knob.Type
	34,  // 242: iterm2.FocusChangedNotification.Window.window_status:type_name -> iterm2.FocusChangedNotification.Window.WindowStatus
	154, // 243: iterm2.SplitTreeNode.SplitTreeLink.session:type_name -> iterm2.SessionSummary
	155, // 244: iterm2.SplitTreeNode.SplitTreeLink.node:type_name -> iterm2.SplitTreeNode
	218, // 245: iterm2.ListSessionsResponse.Window.tabs:type_name -> iterm2.ListSessionsResponse.Tab
	153, // 246: iterm2.ListSessionsResponse.Window.frame:type_name -> iterm2.Frame
	155, // 247: iterm2.ListSessionsResponse.Tab.root:type_name -> iterm2.SplitTreeNode
	154, // 248: iterm2.ListSessionsResponse.Tab.minimized_sessions:type_name -> iterm2.SessionSummary
